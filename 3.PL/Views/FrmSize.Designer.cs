...
partial class FrmSize
{
    ...
    private void InitializeComponent()
    {
        ...
        ((System.ComponentModel.ISupportInitialize)dgrid_size).BeginInit();
        SuspendLayout();
        // 
        // rbtn_khonghoatdong
        // 
        ...
        // dgrid_size
        // 
        dgrid_size.BackgroundColor = Color.White;
        dgrid_size.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
        dgrid_size.Location = new Point(29, 55);
        dgrid_size.Name = "dgrid_size";
        ...
        Text = "FrmSize";
        ((System.ComponentModel.ISupportInitialize)dgrid_size).EndInit();
        ResumeLayout(false);
        PerformLayout();
    }
